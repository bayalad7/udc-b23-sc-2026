...
INSERT INTO eventos (dia, tipo, hora_inicio, hora_fin, facilitador, nombre, descripcion, etiquetas, requerimientos, espacio, cupo_maximo, cupo_disponible, responsable) VALUES
('academico', 'ponencia', '09:00:00', '10:00:00', 'Mtro. Martín Jesús Robles de Anda', 'Ponencia Magistral #1', 'Por definir descripcion', NULL, NULL, 'Auditorio Principal', 180, 180, 'Por definir responsable'),
('academico', 'ponencia', '09:00:00', '10:00:00', 'Dr. Fernando Rodríguez Haro', '¿Cómo piensa una IA? Una introducción a los LLMS', 'Esta sesión ofrece una mirada fascinante al interior de los Modelos de Lenguaje Grande (LLMs), la tecnología detrás de herramientas como ChatGPT. El objetivo es desmitificar la Inteligencia Artificial generativa y explicar, sin tecnicismos complejos, el verdadero mecanismo detrás de sus respuestas. A lo largo de la introducción, se explora cómo estas herramientas procesan la información, rompiendo el mito de que "piensan" como los humanos y revelando su verdadera naturaleza: motores estadísticos avanzados de predicción lingüística.', 'Inteligencia artificial, Tecnología, LLM, ChatGPT, Divulgación', NULL, 'Aula 1', 40,  40, 'Por definir responsable'),
('academico', 'ponencia', '09:00:00', '10:00:00', 'Dra. Sandra Castillo Leal', 'El Camino del Emprendedor', 'Emprender no es un destino, es un viaje de resistencia, aprendizaje y transformación. En esta ponencia, recorreremos el verdadero mapa del emprendimiento, más allá del romanticismo de las redes sociales. Analizaremos cómo superar el miedo al fracaso, la importancia de la resiliencia ante los obstáculos y cómo mantener la pasión encendida cuando los planes no salen como esperabas. Una conferencia diseñada para inspirarte a dar el primer paso y darte las herramientas mentales necesarias para no detenerte en el camino.', 'Emprendimiento, Negocios, Resiliencia, Desarrollo personal', NULL, 'Aula 2', 40,  40,  'Por definir responsable'),
('academico', 'ponencia', '09:00:00', '10:00:00', 'Dr. Lucio Guillén Mercado', 'Inscripción al RFC, e.firma y mis obligaciones fiscales', 'Iniciar la vida profesional o emprender un negocio trae consigo grandes retos, y el más temido suele ser el tema fiscal. En esta ponencia aprenderás de forma sencilla y sin tecnicismos complejos los tres pilares fundamentales para estar al corriente con el SAT. Descubriremos paso a paso cómo tramitar tu Inscripción al RFC y qué regímenes existen, la importancia de la e.firma como tu identidad digital para firmar trámites desde cualquier lugar, y cómo identificar tus obligaciones fiscales según tu actividad. Al terminar, tendrás el mapa de ruta definitivo para perderle el miedo al SAT y tomar el control de tu situación fiscal con total seguridad.', 'Impuestos, SAT, Trámites, Educación financiera, Vida profesional', NULL, 'Aula 3', 40,  40,  'Por definir responsable'),
('academico', 'taller',   '09:00:00', '10:00:00', 'Mtro. Javier Tonatiuh Quiñones Pérez', 'Tu futuro, tus decisiones', 'Diseñado para despertar tu poder personal y guiarte en la construcción consciente de tu camino. A través de dinámicas de reflexión profunda y autoconocimiento, este encuentro te invita a dejar atrás el rol de espectador para convertirte en el verdadero arquitecto de tu vida. No se trata solo de planificar el mañana, sino de entender cómo cada pequeña elección del presente moldea la realidad que deseas habitar.', 'Proyecto de vida, Autoconocimiento, Toma de decisiones, Desarrollo personal', 'Tapete o sábana para sentarse o acostarse en el piso', 'Explanada', 40,  40, 'Por definir responsable');
...
INSERT INTO eventos (dia, tipo, hora_inicio, hora_fin, facilitador, nombre, descripcion, etiquetas, requerimientos, espacio, cupo_maximo, cupo_disponible, responsable) VALUES
('academico', 'taller', '10:30:00', '12:30:00', 'Dr. Miguel Ángel Durán Fonseca', 'Electrónica desde cero: construye y experimenta', 'Vivimos en un entorno donde los objetos cotidianos, las fábricas y los vehículos interactúan con nosotros de forma cada vez más autónoma. Pero, ¿cómo logra un circuito de silicio comprender lo que ocurre a su alrededor? Este encuentro propone un viaje fascinante a través de la ingeniería electrónica y la inteligencia artificial, explorando el puente tecnológico que transforma un estímulo físico en una decisión inteligente.', 'Electrónica, Ingeniería, Sensores, Inteligencia artificial, Tecnología', NULL, 'Aula 1', 40, 40, 'Por definir'),
('academico', 'taller', '10:30:00', '12:30:00', 'Mtro. Sergio Iván Frías Cárdenas', 'Manual de supervivencia: mi proyecto de vida', '¿Sabes hacia dónde vas o estás dejando tu futuro al azar? En esta ponencia exploraremos qué es un Proyecto de Vida y cómo transformarlo en una hoja de ruta clara, realista y motivadora. A través del autoconocimiento y la gestión de metas, los asistentes aprenderán a identificar sus fortalezas, definir objetivos a corto, mediano y largo plazo, y tomar decisiones alineadas con sus verdaderos valores. Una sesión práctica diseñada para pasar de la intención a la acción y empezar a construir el futuro que realmente deseas.', 'Proyecto de vida, Autoconocimiento, Metas, Desarrollo personal', NULL, 'Aula 2', 40, 40, 'Por definir'),
('academico', 'taller', '10:30:00', '12:30:00', 'Dr. Lucio Guillén Mercado', 'Finanzas e impuestos personales', 'Tomar el control de tu futuro financiero requiere entender tanto lo que ganas como lo que debes pagar. En esta ponencia, aprenderás a estructurar un presupuesto sólido, optimizar tus ahorros y diseñar inversiones inteligentes. Además, desmitificaremos el mundo fiscal: descubrirás cómo gestionar tus impuestos de forma legal y eficiente, aprovechando las deducciones disponibles para evitar sorpresas y proteger tu patrimonio. Una guía práctica para hacer que tu dinero trabaje para ti.', 'Educación financiera, Presupuesto, Ahorro, Inversión, Impuestos', NULL, 'Aula 3', 40, 40, 'Por definir'),
('academico', 'taller', '10:30:00', '12:30:00', 'Mtra. ¿?', 'Mocktail: preparación de bebidas sin alcohol', '¡Descubre el arte de la coctelería sin alcohol! En este taller práctico, aprenderás a diseñar y preparar mocktails, bebidas sofisticadas que combinan frescura, balance y creatividad sin una sola gota de alcohol. A lo largo de la sesión, exploraremos el uso de frutas de temporada, hierbas aromáticas, jarabes artesanales y combinaciones de texturas para crear experiencias visuales y rústicas sorprendentes. Este espacio está diseñado tanto para aficionados de la gastronomía como para quienes buscan opciones de consumo conscientes, saludables y llenas de sabor para cualquier evento social.', 'Mocktails, Coctelería Sin Alcohol, Bebidas Saludables, Taller De Coctelería, Mixología Sin Alcohol', NULL, 'Explanada', 40, 40, 'Por definir');
...
INSERT INTO eventos (dia, tipo, hora_inicio, hora_fin, facilitador, nombre, descripcion, etiquetas, requerimientos, espacio, cupo_maximo, cupo_disponible, responsable) VALUES
('cultural', 'taller', '14:00:00', '16:00:00', 'Dr. Javier Larios Nogueda', 'Cuando las palabras no bastan: música para sentir y expresar', 'La música forma parte de nuestra vida cotidiana y tiene la capacidad de despertar recuerdos, expresar emociones y comunicar aquello que en ocasiones resulta difícil decir con palabras. En este taller se invitará a los estudiantes a descubrir cómo diferentes canciones y melodías pueden ayudarnos a identificar, comprender y expresar nuestros sentimientos. Durante la sesión se compartirán ejemplos musicales y se analizará una canción desde la perspectiva de las emociones que transmite, propiciando la participación y reflexión de los estudiantes.', 'Música, Emociones, Expresión artística, Bienestar', NULL, 'Aula X', 50, 50, 'Por definir responsable'),
('cultural', 'taller', '14:00:00', '16:00:00', 'Est. Oscar Jael Jiménez García', 'Mira diferente: el arte de fotografiar con tu celular', 'La fotografía está al alcance de todos gracias a los teléfonos celulares. Sin embargo, tomar una buena fotografía no depende únicamente de tener una buena cámara, sino de aprender a observar, encontrar el momento adecuado y utilizar algunos principios básicos de composición. En este taller los estudiantes conocerán de manera práctica algunos elementos fundamentales para mejorar sus fotografías utilizando únicamente su teléfono celular.', 'Fotografía, Composición visual, Creatividad, Taller práctico', 'Teléfono celular con cámara', 'Aula X', 50, 50, 'Por definir responsable'),
('cultural', 'taller', '14:00:00', '16:00:00', 'Est. Dayra Figueroa Pineda', 'Van Gogh: colores, emociones y libertad', 'Vincent van Gogh es uno de los artistas más reconocidos de la historia del arte. Su manera particular de utilizar los colores, las formas y las pinceladas convirtió sus obras en una poderosa forma de expresar emociones y su manera de percibir el mundo. En este taller los estudiantes realizarán un acercamiento a la vida y obra de Van Gogh, descubriendo cómo el arte puede convertirse en un medio para expresar sentimientos, pensamientos y experiencias personales.', 'Arte, Pintura, Historia del arte, Van Gogh, Expresión artística', NULL, 'Aula X', 50, 50, 'Por definir responsable'),
('cultural', 'taller', '14:00:00', '16:00:00', 'Mtro. Giovanni García Vargas', 'Git + GitHub aplicado al desarrollo de software', 'En el desarrollo de software actual, escribir código de calidad es solo la mitad del trabajo; la otra mitad consiste en saber colaborar, gestionar cambios y asegurar la continuidad del proyecto. Git y GitHub se han consolidado como las herramientas estándar de la industria para resolver estos desafíos, transformando la manera en que los equipos de ingeniería de software construyen tecnología.', 'Programación, Git, GitHub, Control de versiones, Trabajo en equipo', 'Cuenta de GitHub creada antes del taller (registro gratuito en github.com)', 'Aula de cómputo', 50, 50, 'Mtro. Benjamín Ayala Domínguez'),
('cultural', 'taller', '14:00:00', '16:00:00', 'Mtro. Obed Guzmán Ceja', 'La topografía en nuestro entorno', '¿Alguna vez te has preguntado cómo se diseñan las carreteras que recorres, cómo se planifican las ciudades o por qué los mapas digitales de tu celular son tan precisos? Todo esto es posible gracias a la topografía, la ciencia y el arte de medir y representar la superficie de la Tierra.En este taller dinámico y práctico, los participantes dejarán a un lado los libros de texto para convertirse en exploradores de su propio entorno. A través de actividades vivenciales, descubrirán cómo se mide el mundo real y cómo esos datos se transforman en planos y mapas esenciales para la ingeniería, la arquitectura y el cuidado del medio ambiente.', 'Topografía, Ingeniería, Mapas, Medio ambiente, Taller práctico', NULL, 'Aula X', 50, 50, 'Por definir responsable'),
('cultural', 'taller', '14:00:00', '16:00:00', 'Dr. Sergio Aguilar Olguín', 'Colecciones biológicas y fauna silvestre de ecosistemas costeros', 'Los ecosistemas costeros albergan una biodiversidad asombrosa y única, que actúa como un puente vital entre la tierra y el mar. Este taller teórico-práctico ofrece una inmersión al fascinante mundo relacionado al conocimiento de especies de fauna silvestre que vivien en ecosistemas costeros y marinos del estado de Colima.', 'Biología, Biodiversidad, Fauna silvestre, Ecosistemas costeros, Colima', NULL, 'Aula X', 50, 50, 'Por definir responsable'),
('cultural', 'taller', '14:00:00', '16:00:00', 'Dr. Miguel Ángel Cibrián Sánchez', 'El viaje de tu iPhone / Tenis / Consola (Logística e Importación en la vida diaria)', 'Analiza cómo los objetos que usamos todos los días recorren miles de kilómetros y cruzan fronteras antes de llegar a nuestras manos. El objetivo de este taller es visibilizar la complejidad de la cadena de suministro global y cómo la logística conecta la economía mundial con nuestra rutina diaria.', 'Logística, Importación, Aduanas, Comercio Exterior, Cadena de Suministro, Envíos Internacionales, Impuestos Aduaneros', NULL, 'Aula X', 50, 50, 'Por definir responsable');
